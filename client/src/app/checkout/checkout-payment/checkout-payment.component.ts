...
import { loadStripe, Order, Stripe, StripeCardCvcElement, StripeCardExpiryElement, StripeCardNumberElement } from '@stripe/stripe-js';
...
export class CheckoutPaymentComponent implements OnInit {
  ...
  private getOrderToCreate(basket: Basket): OrderToCreate {
    ...
    console.log('Model ' + basket.items);
